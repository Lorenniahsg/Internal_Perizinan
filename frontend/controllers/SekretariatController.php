            ...
            if ($model->load(Yii::$app->request->post())){
                ...
                foreach ($names as $name) 
                {
                    ...
                    if ($name->saveAs($path)){
                        ...
                        Yii::$app->db->createCommand()->insert('sekretariat', ['file'=>$file, 'filepath' => $filepath,'no_surat'=> $model->no_surat, 'pengirim'=> $model->pengirim, 'tanggal' => $model->tanggal, 'perihal' => $model->perihal])->execute();
                    }                
                }
